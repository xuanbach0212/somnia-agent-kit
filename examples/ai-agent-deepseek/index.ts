/**
 * AI Agent with DeepSeek LLM
 * Complete example showing AI agent with LLM reasoning on Somnia blockchain
 */
...
async function main() {
  console.log('🤖 AI Agent with DeepSeek LLM Demo\n');
  ...
  console.log('🧠 Step 2: Initialize DeepSeek LLM...');
  ...
  console.log('✅ DeepSeek LLM connected\n');
  ...
  // 4. AI Agent Planning - Use LLM to decide what to do
  console.log('🤔 Step 3: AI Agent Planning...');
...
Format your response as JSON:
{
  ...
  console.log('   🧠 Asking DeepSeek for agent details...');
  ...
  console.log('📋 Agent Details (from AI):');
...
Respond with: YES or NO, followed by a brief reason.`;
  ...
  console.log('   🧠 Asking DeepSeek for decision...');
...
Provide a brief, enthusiastic summary (2-3 sentences) of what this means for AI agents on blockchain.`;
  ...
  console.log('   🧠 Asking DeepSeek for summary...');
  ...
  console.log('   1. ✅ DeepSeek LLM planned agent details');
  ...
  console.log();
  console.log('🚀 This is an AI agent with reasoning capabilities on-chain!');
}
